...
export const DEFAULT_TEMPLATES = [
  {
    ...
    name: "Android",
    platform: "android",
    description: "Android 模板：TUN + Tailscale 回家 + FCM/Google Play 规则。所有流量经 🚀 默认代理，CN 域名直连。",
  ...
  },
  {
    ...
    name: "NAS",
    platform: "nas",
    description: "Debian NAS 透明旁路由：TUN 全接管 + 国内/国外 DNS 分流。LAN 客户端设网关/DNS 为本机即可。",
  ...
  },
  {
    ...
    name: "Windows",
    platform: "windows",
    description: "Windows 桌面模板：本机代理 + TUN 关闭，fake-ip DNS 分流，无 Tailscale。",
